-- Crea solo le tabelle per gruppi e responsabili (la tabella utenti esiste già)
...
-- 2. Tabella di associazione utenti-gruppi
...
-- 4. Campo JSON nel template scadenze
...
-- 7. Verifica
SELECT 'Gruppi e responsabili creati!' as status,
       COUNT(*) as gruppi_creati
