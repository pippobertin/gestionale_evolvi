      ...
      if (fallbackError) {
        ...
        return Response.json({
          ...
          data: [
            ...
            { column_name: 'numero_volontari', data_type: 'integer', is_nullable: 'YES' },
            ...
            { column_name: 'durata_evolvi', data_type: 'character varying', is_nullable: 'YES' },
            ...
            { column_name: 'indirizzo_fatturazione', data_type: 'text', is_nullable: 'YES' },
            { column_name: 'cap_fatturazione', data_type: 'character varying', is_nullable: 'YES' },
            { column_name: 'provincia_fatturazione', data_type: 'character varying', is_nullable: 'YES' },
            { column_name: 'stato_fatturazione', data_type: 'character varying', is_nullable: 'YES' },
            ...
            { column_name: 'sdi', data_type: 'character varying', is_nullable: 'YES' },
            { column_name: 'coordinate_bancarie', data_type: 'character varying', is_nullable: 'YES' },
            ...
            { column_name: 'ula', data_type: 'numeric', is_nullable: 'YES' },
